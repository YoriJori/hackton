										...
										<form enctype="multipart/form-data" method="post" action="<?php echo ACTION ?>" class="w-100" novalidate>
											...
											<div class="form-row col-12 por mt-4">
												<div class="form-group col-12 por d-flex fl-cc  was-validated">
													<input type="text" name="book" id="book" class="form-control formChk bookbook" required>
													<label for="book" class="poa t0 l0" >title</label>
													<div class="meter"></div>
													<div class="invalid-feedback">title 입력해주세요</div>
												</div>
											</div>	
											<div class="form-row col-12 por mt-5">
												<div class="form-group col-12 por d-flex fl-cc  was-validated">
													...
													<div class="meter"></div>
													<div class="invalid-feedback">사진 선택해주세요</div>
												</div>
											</div>	
											<!-- <div class="form-row col-12 por mt-4">
												<div class="form-group col-12 por d-flex fl-cc  was-validated">
													<input type="text" name="writer" id="writer" class="form-control formChk writer" required>
													<label for="writer" class="poa t0 l0" >종류</label>
													<div class="meter"></div>
													<div class="invalid-feedback">종류을 입력해주세요</div>
												</div>
											</div>	 -->
											...
											<div class="form-row col-12 por mt-4">
												<div class="form-group w-100 por d-flex fl-cc ">
													<button class="bg0 col-4 p-2 ml-1 fc1 at_sc12 okBtn" type="submit">맛집추가</button>
